...
baseFolder = '\Users\Elsa Marianelli\Documents\grids_data_trap_env_SR_500_placecells_trapezoid_figs';
...
basenames = { ...
    'data_SR_generate_densityConstant_sizeConstant_WidthControled', ...
...
fileList = { ...
    'Bar_stdGrd_s.fig',       ...%   'Heatmap_expGrd_h.fig', ...
    'Bar_stdGrd_h.fig',    ...%    'Heatmap_expGrd_h_el.fig',...
    'Bar_expGrd_s.fig',    ...%    'Heatmap_orient_peak.fig', ...
    'Bar_expGrd_h.fig',        ...%    'Heatmap_scale_h.fig', ...
    'Bar_expGrd_s_el.fig'       ... %    'Heatmap_eccent.fig' };
    'Bar_expGrd_h_el.fig'        }; 
...
yLimits = {[.20 .60], [],[.5 .90], [], [0 20], [], [40 60], [], [0.4 0.8], []}; %sq
yLimits = {[.20 .50],[.4 .8], [1 7], [60 90], [0.4 0.7]}; % trp
yLimits = {[.0 1.2],[.0 1.2], [.0 1.2], [.0 1.2], [.0 1.2], [.0 1.2]};
...
saveas(masterFig, fullfile(baseFolder,'Comped_Metric_Figures.fig'));
exportgraphics(masterFig, fullfile(baseFolder,'Comped_Metric_Figures.pdf'), ...
               'ContentType','vector');
exportgraphics(masterFig, fullfile(baseFolder,'Comped_Metric_Figures.png'), ...
               'Resolution',300);
exportgraphics(masterFig, ...
    fullfile(baseFolder, 'Comped_Metric_Figures.svg'), ...
    'ContentType', 'vector', ...
