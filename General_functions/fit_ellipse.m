...
if (nargin>2) & ~isempty( axis_handle ) & (test>0)
    ...
    plot( new_ver_line(1,:),new_ver_line(2,:),'k', 'LineWidth', 2);
    plot( new_horz_line(1,:),new_horz_line(2,:),'k', 'LineWidth', 2 );
    plot( rotated_ellipse(1,:),rotated_ellipse(2,:),'k' , 'LineWidth', 2);
