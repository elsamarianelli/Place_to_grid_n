function data       =testRealData_readDACQ( pathFlnm, vars )
%READDACQ Master function to read in raw DACQ data
% Based on the original read_DACQ but cut down for speed in this particular
% context (e.g. doesn't load waveforms, eeg etc)
%
