function [trial] = loadOriginal(in,loadOptions)
...
% else
    [trial, spikeData] = ppTrialOriginal(in.path,in.filename,loadOptions.EEGFilter,in.eegchannel,{'pixels_per_metre',in.ppm});
...
function [trial, spikeData] = ppTrialOriginal(path,filename,EEGFilter,ch,ppm)
